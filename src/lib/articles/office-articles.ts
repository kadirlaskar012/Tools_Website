...
End Sub`,
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'File Intelligence provides a 100% private, client-side XLSX Hidden Sheet Detector that unzips and parses this XML structure directly in your browser memory. It provides an immediate inventory of every sheet, its internal OpenXML sheet ID, and its exact visibility state without uploading the file to any server.',
        ],
      },
      {
        id: 'common-mistakes',
        ...
        paragraphs: [
          ...
          '5. Neglecting External Workbook Links: Hidden sheets often contain links to external workbooks on corporate network shares. Always audit external references before distribution.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          '• Check for Very Hidden Sheets: Inspect the workbook using the VBA editor or an OpenXML tool to verify xlSheetVeryHidden is not present.',
          '• Check External Links: Ensure the workbook does not link to internal network file paths using the XLSX External Link Checker.',
          '• Scrub Document Properties: Remove author names, company templates, and edit times using the DOCX/Office Metadata Checker.',
